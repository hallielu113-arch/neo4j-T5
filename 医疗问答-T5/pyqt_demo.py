...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        MainWindow.setObjectName("基于T5的法律知识问答系统")
    ...
    def retranslateUi(self, MainWindow):
        ...
        MainWindow.setWindowTitle("基于T5的法律知识问答系统")
...
class MainWindow(QMainWindow, Ui_MainWindow):
    ...
    def create_widget(self):
        ...
        result = self.model.generate(self.text, self.t, device=self.device, max_length=500)
